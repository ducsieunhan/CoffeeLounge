                ...
                <section class="cart-bill-container">
                    <div class="cart-bill-wrapper width-container">
                        <div class="billing-details">
                            ...
                            <form action="" class="form-info" id="form-info">
                                <div class="name-row">
                                    <div class="f-name">
                                        <label for="fname">First name <span class="bill-important">*</span></label>
                                        <input type="text" id="firstname" name="firstname" class="input-text" required>
                                    </div>
                                    <div class="l-name">
                                ...
                                <div class="country">
                                    <label for="fname">Country / Region <span class="bill-important">*</span></label>
                                ...
                                <div class="town">
                                    <label for="fname">Town / City <span class="bill-important">*</span></label></label>
                                    <input type="text" id="firstname" name="firstname" class="input-text" required>
                                </div>
                                <div class="postcode">
                        ...
                        <div class="order-details">
                                ...
                                <tbody class="b-table-body">
                                    <tr>
                                        <td class="b-product-name">
                                            Robusta Yellow Honey Processed Coffee Beans - Daklak origin - S18, S16
                                            <strong>x1</strong>
                                        </td>
                                        <td class="b-product-total">$4.48</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="b-product-total"><span>$4.48</span></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr class="b-cart-subtotal">
                                        <th>Subtotal</th>
                                        <td class=""><span>$4.48</span></td>
                                    </tr>
                            ...
                            <button class="form-btn" form="form-info">Place order</button>
