    ...
    <section class="product-detail-container">
        <div class="pro-dt-wrapper width-container">
            ...
            <div class="product-dt-desc pro-dt">
                ...
                <form class="cart" action="" method="" style="gap: 20px ; justify-content: start !important;">

                    <input type="number" name="quantity" value="1" step="1" placeholder="" inputmode="numeric"
                        style="width: 25%; ">

                    <span class="lte-btn-wrap"><button type="submit" name="add-to-cart" value="42105" class="cart-btn"
                            fdprocessedid="r3ri7">Add to cart</button></span>

                </form>
                <div class="category">
                    <div style="color: #4D8B55; font-weight: bolder; font-size: 18px;     font-family: var(--font-family-desc);
">Category:
                        <span style="color: black; font-weight: normal;">${product.category.getName()}</span>
