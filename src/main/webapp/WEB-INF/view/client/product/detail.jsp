            ...
            <body>
                ...
                <section class="swiper-container">
                    <div class="swiper-pagination-container" style="--bg-url: url(/client/images/inner_header.jpg)">
                        <h2 style="width: 60%; text-align: center; line-height: 1;">Robusta S16 S18 Wet Polished | Grade
                            1 | Blue
                            Dragon Beans</h2>
                        <ul class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            ...
                            <li><a href="#" class="current-breadcrumb">Robusta S16 S18 Wet Polished | Grade 1 | Blue
                                    Dragon Beans</a></li>
                        </ul>
                    </div>
                </section>
                    ...
                    <div class="pro-dt-wrapper width-container">
                        ...
                        <div class="product-dt-desc pro-dt">
                            <div class="pro-dt-header">
                                <h1>
                                    Robusta S16 S18 Wet Polished | Grade 1 | Blue Dragon Beans</h1>
                            </div>
                            ...
                            <div class="pro-dt-breadcrumb">
                                <ul class="pro-breadcrumb">
                                    <li><a href="#">Home</a></li>
                                    <li><a href="#">Vietnamese Robusta Green Coffee Beans</a></li>
                                    <li><a href="#">Robusta S16 S18 Wet Polished | Grade 1 | Blue
                                            Dragon Beans</a></li>
                                </ul>
                            </div>
                ...
                <section class="product-desc-container">
                    <div class="pro-desc-wrapper width-container">
                        ...
                        <div class="pro-desc-header">
                            ...
                            <h2 class="header-desc">Vietnam Robusta Coffee Grade 1 SCR 18 Wet Polished | Blue Dragon
                                Beans</h2>
                            <h2 class="header-desc">Discover the Excellence of Vietnam's Finest Robusta Coffee | Blue
                                Dragon Beans
                            </h2>
                            <p>Indulge in the rich, robust flavors of our Vietnam Robusta Coffee Grade 1 SCR 18 Wet
                                Polished.
                                Sourced from the verdant coffee plantations of Vietnam, this premium coffee is crafted
                                with
                                meticulous care to deliver an unparalleled taste experience.</p>
                        </div>
                        ...
                        <div class="pro-desc-spec">
                            ...
                            <ul class="pro-desc">
                                ...
                                <li><span class="bolder-span">Screen Size: </span>90% min above sieve No.18, No.16</li>
                        ...
                        <div class="pro-desc-spec">
                            ...
                            <ul class="pro-desc">
                                ...
                                <li><span class="bolder-span">Port of Loading (POL): </span>Ho Chi Minh Port, Vietnam
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="pro-desc-spec">
                            ...
                            <p>The above-mentioned prices are FOB Ho Chi Minh, excluding international freight charges,
                                import
                                duties, taxes, and other charges at the destination ports, which are the responsibility
                                of the
                                buyer.</p>
                            ...
                            <p>In order to provide you with a seamless experience, we would be grateful if you could
                                provide more
                                information regarding your targeted order quantities, specific quality requirements, and
                                preferred
                            ...
                            <p>We look forward to establishing a strong business relationship with your esteemed
                                organization, and
                                we hope to assist you in meeting your coffee-sourcing objectives. Should you have any
                                further
                                questions or require additional information, please feel free to reach out to us at your
                                convenience.</p>
                            <P>Should you need any further assistance or wish to discuss coffee prices, please feel free
                                to reach
